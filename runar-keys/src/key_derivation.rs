...
impl KeyDerivation {
    ...
    /// Derive a network CA key from a seed and network ID
    pub fn derive_network_ca_key(seed: &[u8], network_id: &str) -> Result<SigningKeyPair> {
        // Hash the network ID to get a deterministic index
