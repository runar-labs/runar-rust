...
async fn test_gateway_routes() -> Result<()> {
    ...
    logger.debug(format!("Testing GET: {ping_url}"));
    ...
    logger.debug(format!("GET /{echo_service_path}/ping successful."));
    ...
    logger.debug(format!("Testing POST: {echo_url} with payload: {payload}"));
    ...
    logger.debug(format!("POST /{echo_service_path}/echo successful."));
    ...
    logger.debug(format!("Testing POST response: {response_body_map}"));
    assert_eq!(response_body_map, map_payload);
    logger.debug("POST /{echo_service_path}/echo_map successful.");
    ...
    logger.debug(format!("POST /{echo_service_path}/echo_struct successful."));
