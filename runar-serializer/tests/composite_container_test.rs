...
fn test_mixed_content_containers() -> Result<()> {
    ...
    // Add a string
    mixed_map.insert("description".into(), ArcValue::new_primitive("Mixed content test".to_string()));
    
    // Add a list of primitives
    mixed_map.insert("scores".into(), ArcValue::new_list(vec![
