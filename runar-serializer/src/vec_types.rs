use crate::map_types::StringToStringMap;
...
impl VecHashMapStringString {
    pub fn from_vec_hashmap(vec: Vec<HashMap<String, String>>) -> Self {
        let entries = vec
            .into_iter()
            .map(|map| StringToStringMap::from_hashmap(map))
            .collect();
        Self { entries }
    }
...
impl VecHashMapStringInt {
    pub fn from_vec_hashmap(vec: Vec<HashMap<String, i32>>) -> Self {
        let entries = vec
            .into_iter()
            .map(|map| crate::map_types::StringToIntMap::from_hashmap(map))
            .collect();
        Self { entries }
    }
...
impl VecHashMapStringFloat {
    pub fn from_vec_hashmap(vec: Vec<HashMap<String, f64>>) -> Self {
        let entries = vec
            .into_iter()
            .map(|map| crate::map_types::StringToFloatMap::from_hashmap(map))
            .collect();
        Self { entries }
    }
...
impl VecHashMapStringBool {
    pub fn from_vec_hashmap(vec: Vec<HashMap<String, bool>>) -> Self {
        let entries = vec
            .into_iter()
            .map(|map| crate::map_types::StringToBoolMap::from_hashmap(map))
            .collect();
        Self { entries }
    }
